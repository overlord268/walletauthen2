...
class RegisterForm(forms.Form):
  email_field = forms.EmailField(label='Email (Username)', widget=forms.TextInput(attrs={'placeholder': 'example@email.com', 'class': 'form-control'}))
  ...
  id_field = forms.CharField(label='Número de identidad', max_length=18, required=False, widget=forms.TextInput(attrs={'placeholder': '', 'class': 'form-control'}))
