...
class CompraForm(forms.Form):
  ...
  amount_field = forms.FloatField(label='Bitcoin', widget=forms.TextInput(attrs={'class': 'form-control'}))
  lempiras_field = forms.FloatField(label='Lempiras', widget=forms.TextInput(attrs={'class': 'form-control'}))
  cambio_btc_lempiras = forms.FloatField(label='Cambio', widget=forms.HiddenInput(attrs={'class': 'form-control'}))
